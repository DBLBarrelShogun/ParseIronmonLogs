...
if runMode != "Existing":
    for x in range(1, 1000):
        subprocess.run('java -Xmx4608M -jar "C:\\Users\\ocelo\\Downloads\\Emus\\Ironmon-Tracker\\extensions\\roguemon\\roguemon_randomizer_natdex.jar" cli -s "C:\\Users\\ocelo\\Downloads\\Emus\\Ironmon-Tracker\\extensions\\roguemon\\Roguemon Settings Files\\Ascension 1 Bug.rnqs" -i "C:\\Users\\ocelo\\Downloads\\PokemonROMs\\FRLG\\NatDex\\FRLG_natdex.gba" -o "C:\\Projects\\RoguemonEvos\\logs\\A1BugAutoRandomized'+str(x)+'.gba" -l', capture_output=True)
        sys.stderr.write("Processed: " + str(x) + "\n")
    ...
    for logfile in os.listdir("logs"):
        if os.path.splitext(logfile)[1] == ".gba":
            continue
        with open("logs/"+logfile, "r") as f:
            startParse = False
            seedString = ""
